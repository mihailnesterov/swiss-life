...
export const investorRoutes = [
    ...
    {id: 8, path: RouteNames.PARTNERS, element: Partners, navbar: true, icon: <FontAwesomeIcon icon={solid('handshake')} />, title: "Партнеры"},
    {id: 9, path: RouteNames.PARTNERS_ITEM_PAGE, element: PartnerItemPage, navbar: false, icon: <FontAwesomeIcon icon={solid('handshake')} />, title: "Партнер"},
    ...
    {id: 11, path: RouteNames.CONTRACTS_ITEM_PAGE, element: ContractItemPage, navbar: false, icon: <FontAwesomeIcon icon={solid('file-contract')} />, title: "Договор"},
    {id: 12, path: RouteNames.PROFILE, element: Profile, navbar: false, icon: <FontAwesomeIcon icon={solid('user-tie')} />, title: "Мой профиль"},
    {id: 13, path: RouteNames.ERROR404, element: Error404, navbar: false, title: "404 ошибка"},
    {id: 14, path: RouteNames.NEWS_ITEM_PAGE, element: NewsItemPage, navbar: false, icon: <FontAwesomeIcon icon={solid('newspaper')} />, title: "Новость"},
    {id: 15, path: RouteNames.INVESTMENT_ITEM_PAGE, element: InvestmentItemPage, navbar: false, icon: <FontAwesomeIcon icon={solid('briefcase')} />, exact: true, title: "Объект инвестирования"},
    {id: 16, path: RouteNames.USERS_ITEM_PAGE, element: UserItemPage, navbar: false, icon: <FontAwesomeIcon icon={solid('user')} />, title: "Пользователь"},
];
