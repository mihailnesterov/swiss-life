...
const getBaseUrl = () => {
    return process.env.NODE_ENV === 'development' ? 
            process.env.REACT_APP_MANAGER_DEV_URL :
            process.env.REACT_APP_MANAGER_PROD_URL;
}

// get REST API url from process.env
const getApiUrl = () => {
    return process.env.NODE_ENV === 'development' ? 
            process.env.REACT_APP_MANAGER_API_DEV_URL :
            process.env.REACT_APP_MANAGER_API_PROD_URL;
}
