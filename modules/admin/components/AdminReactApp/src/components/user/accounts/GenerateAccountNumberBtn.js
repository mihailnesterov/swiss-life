...
const GenerateAccountNumberBtn = (props) => {
    ...
    const {setAccountNumber, currency} = props;

    const onClickHandler = () => setAccountNumber(
            generateAccountNumber(currency && currency.code && currency.code)
        );
    ...
    return (
        <button
            ...
            disabled={currency && currency.code ? false : true}
        >
